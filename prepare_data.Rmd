...
```{r}
df_sites <- read_csv("~/data/archive_legacy/flue/flue_stocker18nphyt.csv")  # dataset available here: https://zenodo.org/record/1158524#.YFn9fkhKjUI
...
gg1 <- plot_map_simpl() +
  geom_point(data = df_sites, aes(x = lon, y = lat, fill = classid), shape = 21, color = "black") +
  # scale_color_jcolors(palette = "pal8")
  scale_color_brewer(palette = "Paired", name = "Vegetation type")
  # scale_colour_manual(values = myjcolors(length(unique(df_sites$classid))), name = "Vegetation type")

gg1
ggsave("fig/map_sites_mlflx.pdf", width = 10, height = 5)
```
