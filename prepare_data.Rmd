...
Write to file.
```{r}
write_csv(ddf, path = "data/ddf_fluxnet_mlflx_20210505.csv")
save(ddf, file = "data/ddf_fluxnet_mlflx_20210505.RData")
```
...
```{r}
# load("data/ddf_fluxnet_mlflx_wscal_20210413.RData")
df_sites <- read_csv("./data/df_sites_mlflx.csv")
