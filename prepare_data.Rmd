...
Write to file.
```{r}
write_csv(ddf, path = "data/ddf_fluxnet_mlflx_20210413.csv")
save(ddf, file = "data/ddf_fluxnet_mlflx_20210413.RData")
```
...
write_csv(ddf, path = "data/ddf_fluxnet_mlflx_wscal_20210413.csv")
save(ddf, file = "data/ddf_fluxnet_mlflx_wscal_20210413.RData")
```
...
Write to file.
```{r}
write_csv(df_modis_fpar, path = "data/ddf_fpar_modis_mlflx_20210414.csv")
save(df_modis_fpar, file = "data/ddf_fpar_modis_mlflx_20210414.RData")
```
...
write_csv(ddf_mlflx, path = "data/ddf_combined_mlflx_20210413.csv")
```
